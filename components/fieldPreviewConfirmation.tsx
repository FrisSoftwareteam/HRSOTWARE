...
import { renderFormFieldComponentViewers } from "./render-form-field-component-component";
...
export const FieldPreviewConfirmation = React.forwardRef<
  HTMLDivElement,
  FieldProps
    ...
    >
      ...
      <div className="w-full">
        <FormField
          ...
          name={formField.name}
          render={({ field }) =>
            // renderFormFieldComponent({field})
            renderFormFieldComponentViewers({ field, formField })
          }
        />
      </div>
      <Button
...
FieldPreviewConfirmation.displayName = "FieldPreview";
