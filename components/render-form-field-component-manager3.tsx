...
export function renderFormFieldComponentManager3({
  formField,
  field,
            ...
            <FormControl>
              <>
                <RadioGroup
                  ...
                  onValueChange={(e: any) => {
                    formField.groupHeadInput = e;
                    field.onChange(e);
                  }}
                  defaultValue={formField?.divisionalInput as string}
                  onChange={(e: any) => {
                    formField.groupHeadInput = e.target?.value;
                  }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => {
                          // console.log(e.target.value);
                          formField.commentsGroupHead = e.target.value;
                        }}
                      />
                    </div>
                  </div>
