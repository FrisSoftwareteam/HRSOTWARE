        ...
        {show && (
          <div className="flex flex-col items-center justify-center h-50 w-auto  rounded-lg shadow-md bg-gray-100 p-4  ">
            ...
            <p className="mb-3 px-9 items-center justify-center text-gray-800">
              <strong>{profile.name}</strong>, You gave the appraisee the rating
              shown below. Please, the workflow has proceeded to the next
              authority/reporting-chain for action.
            </p>
              ...
              {isLoading ? (
                ...
                <>
                  {data?.map((formField: FormField) => {
                    console.log(formField.hodInput);
